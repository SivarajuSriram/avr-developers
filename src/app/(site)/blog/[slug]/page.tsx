  ...
  return (
    <>
      <section className="relative flex min-h-[64dvh] flex-col justify-end overflow-hidden text-white">
        ...
        <div className="relative mx-auto w-full max-w-[1400px] px-5 pb-12 pt-28 lg:px-10 lg:pb-16">
      ...
      <section className="mx-auto max-w-[760px] px-5 pb-10 pt-6 lg:max-w-[980px] lg:px-10 lg:pb-14 lg:pt-8">
        <Reveal>
          <Link
            href="/blog"
